...
public class TrophiesListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_throphies_list);
    ...
    private void firebaseSearch(String searchText) {
        ...
        FirebaseRecyclerAdapter<Trophy, TrophyViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Trophy, TrophyViewHolder>(options) {

                    protected void onBindViewHolder(TrophyViewHolder viewHolder, int position, Trophy model) {
                        viewHolder.setDetails(getApplicationContext(), model.getSport(), model.getYear(), model.getDescription(), model.getImageUrl());
                    }
                    ...
                    public TrophyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                        ...
                        viewHolder.setOnClickListener(new TrophyViewHolder.ClickListener() {
                            @Override
                            public void onItemClick(View view, int position) {
                                //Views
                                TextView mTitleTv = view.findViewById(R.id.rSportTv);
